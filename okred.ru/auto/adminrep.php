...
<?php
include("var.php");
echo "<head><title>Администрирование - Добавление отчета : $sitename</title>";
include("top.php");
echo "<center><h3>Добавление отчета</h3>";
...
{
$body .= "$dati[2].$dati[1].$dati[0]&nbsp;&nbsp;&nbsp;<br><big><b>$title</b></big><br>$preview<br><a href=\"$siteadress/report.php?link=$idnum\">Подробнее</a>&nbsp;&raquo;<br><br>";
}
elseif($preview != "" and $detail == "")
{
...
$body .= "<a href=$siteadress/report.php>Посмотреть все отчеты</a>&nbsp;&raquo;</p>";
...
echo "<center><br><br>$stroka<br><br><a href=adminrep.php>Добавить еще отчет</a><br><br><a href=admin.php>На общую страницу администрирования</a><br><br>";
}
} // ok
include("down.php");
?>