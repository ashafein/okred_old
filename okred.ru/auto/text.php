...
if ($link == '')
{
if (!isset($g) or $g == '') {echo "<title>Статьи : $sitename</title>";}
if ($g != '') {
...
if (eregi('ФОТО1',$text) and $foto1 != ""){$text=@str_replace('ФОТО1',"<img src=$photodir$foto1 border=0 align=left width=100%>",$text);}
if (eregi('ФОТО2',$text) and $foto2 != ""){$text=@str_replace('ФОТО2',"<img src=$photodir$foto2 border=0 align=left width=100%>",$text);}
if (eregi('ФОТО3',$text) and $foto3 != ""){$text=@str_replace('ФОТО3',"<a href=$photodir$foto3 target=_blank><img src=$photodir$foto3 border=0 align=left width=100%>></a>",$text);}
if (eregi('ФОТО4',$text) and $foto4 != ""){$text=@str_replace('ФОТО4',"<a href=$photodir$foto4 target=_blank><img src=$photodir$foto4 border=0 align=left width=100%>></a>",$text);}
if (eregi('ФОТО5',$text) and $foto1 != ""){$text=@str_replace('ФОТО5',"<a href=$photodir$foto5 target=_blank><img src=$photodir$foto5 border=0 align=left width=100%>></a>",$text);}
