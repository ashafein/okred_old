...
/** Вид виджета авторизации */
	...
	private $fields_req=array('email');
	private $fields_opt=array();
	private $providers_default=array('vkontakte','odnoklassniki','facebook','twitter','googleplus','google','yandex','mailru','livejournal');
	private $fields_default=array('first_name','last_name','email');
	private $type='small';
