    ...
    return @mail("$to", "$subj", $zag, $head); 
							...
							{ //has
								...
								{ //while
									...
									$lsrgender='';
									$lsrcomment='';
									if ($podrazdel != '' and $podrazdel != '0' and $podrazdel != '%'){$lsrpodrazdel="and podrazdel = $podrazdel";}
									if ($razdel != '' and $razdel != '0' and $razdel != '%') {$lsrrazdel="and razdel = $razdel";}
									...
									{ // есть совпадение
										...
										{ // while2
											...
											{ // short
												...
												$body=("<a href=$siteadress/linkres.php?link=$ID><b>$profecy</b></a>");
												if ($zp != 0) {$body .="&nbsp;-&nbsp;\$$zp";}
												$body .="<br>";
												$br=0;
												$br=0;
												...
												$body .= ("<br><a href=$siteadress/linkres.php?link=$ID>Подробнее...</a><br><br>");
											} // short
											if ($rasfull == 'TRUE')
											{ // full
												$ID=$myrow2["ID"];
...
//<!-- рекламный блок рассылки -->
							...
							if (mysql_num_rows($resultsend) != 0){ //send
								...
								while ($myrow=mysql_fetch_array($resultsend)){ //while3
									$said=$myrow["aid"];
									$hID=$myrow["ID"];
									$txtbody=$myrow["txt"];
...
");
				if ($imgobyavlconfirm == 'TRUE'){ // img conf
