...
{
$resultadd2 = @mysql_query("SELECT * FROM $podcattable WHERE id='$srpodrazdel'");
while($myrow=mysql_fetch_array($resultadd2)) {
$podrazdelsh=$myrow["name"];
}
}
$resultadd1 = @mysql_query("SELECT * FROM $cattable WHERE ID='$srrazdel'");
while($myrow=mysql_fetch_array($resultadd1)) {
$razdelsh=$myrow["name"];
}
...
$result2 = @mysql_query("SELECT * FROM $cattable order by name");
...
if ($srrazdel != '')
{
$result3 = @mysql_query("SELECT * FROM $podcattable WHERE dict_prof_area_id=$srrazdel order by name");
...
$resultadd2 = @mysql_query("SELECT id, name FROM $podcattable WHERE id='$wpodrazdel'");
while($myrow=mysql_fetch_array($resultadd2)) {
$podrazdel1=$myrow["name"];
}
$resultadd1 = @mysql_query("SELECT id, name FROM $cattable WHERE id='$wrazdel'");
while($myrow=mysql_fetch_array($resultadd1)) {
$razdel1=$myrow["name"];
}
