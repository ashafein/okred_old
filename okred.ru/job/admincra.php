...
echo "<br><br><h3 align=center>Изменения сохранены!</h3><p align=center><a href=adminmca.php>На страницу редактирования разделов</a><br><br><a href=admin.php>На страницу администрирования</a></p><br><br>";
}
} //firmid
if (!isset($id) or $id=='')
{
echo "<center><br><br><h3>Раздел не определен!</h3><b><a href=adminmca.php>Вернуться</a></b><br><br>";
}
} //ok
include("down.php");
?>