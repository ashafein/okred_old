...
<?php
include("var.php");
echo "<head><title>Администрирование - Правка отчета: $sitename</title>";
include("top.php");
echo "<center><h3>Правка отчета</h3>";
...
{
echo "<center><b>Позиция не определена. Вернитесь на страницу <a href=adminrd.php>удаления!</a></b><br><br>";
}
else
{ // ok
...
<table>
<tr><td align=right valign=top>К мероприятию:</td>
...
<tr><td align=right>Горячий отчет:</td>
<td><input type=checkbox name=hot value=checked $hot></td>
<tr><td align=right>Обновить дату:</td>
...
ФОТО6: <input type=file name=file6 size=30><br>
ФОТО7: <input type=file name=file7 size=30><br>
ФОТО8: <input type=file name=file8 size=30><br>
ФОТО9: <input type=file name=file9 size=30><br>
ФОТО10: <input type=file name=file10 size=30><br>
<br>
</td></tr>
</table>
");
echo "<center><p><input type=submit value=\"Изменить\" name=\"submit\"></form>";
echo "<center><a href=adminrd.php>Вернуться на страницу удаления</a><br><br><a href=admin.php>На общую страницу администрирования</a><br><br>";
}
else {
echo "<b>Изменения сохранены!</b><br><br><a href=adminrd.php>Вернуться на страницу удаления</a><br><br><a href=admin.php>На общую страницу администрирования</a><br><br>";
}
} // ok
include("down.php");
?>