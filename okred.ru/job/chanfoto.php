...
if ($textconfirm=='TRUE') {$status='wait';$stroka='<b>После проверки изменений администратором объявление будет добавлено в базу сайта.</b>';}
elseif ($textconfirm=='FALSE') {$status='ok';$stroka='<b>В течение нескольких минут изменения вступят в силу</b>';}
if (isset($upload)) {
$fid=$texid;
$updir=$photodir;
$path1 = $upath."$updir";
...
$foto5line="";
if ($foto1 != "")
{$foto1line="<td align=center><a href=$photodir$foto1 target=_blank><img src=$domenmainurl/$photodir$foto1 border=0 height=150></a><br><input type=submit name=delete1 value=Удалить class=i3></td>";
$foto1upl="";
}
if ($foto2 != "")
{$foto2line="<td align=center><a href=$photodir$foto2 target=_blank><img src=$domenmainurl/$photodir$foto2 border=0 height=150></a><br><input type=submit name=delete2 value=Удалить class=i3></td>";
$foto2upl="";
}
if ($foto3 != "")
{$foto3line="<td align=center><a href=$photodir$foto3 target=_blank><img src=$domenmainurl/$photodir$foto3 border=0 height=150></a><br><input type=submit name=delete3 value=Удалить class=i3></td>";
$foto3upl="";
}
if ($foto4 != "")
{$foto4line="<td align=center><a href=$photodir$foto4 target=_blank><img src=$domenmainurl/$photodir$foto4 border=0 height=150></a><br><input type=submit name=delete4 value=Удалить class=i3></td>";
$foto4upl="";
}
if ($foto5 != "")
{$foto5line="<td align=center><a href=$photodir$foto5 target=_blank><img src=$domenmainurl/$photodir$foto5 border=0 height=150></a><br><input type=submit name=delete5 value=Удалить class=i3></td>";
$foto5upl="";
}
echo ("
...
echo "<br><br><h3 align=center>Изменения сохранены!</h3><center><br><br>$stroka<br><br><a href=chanfoto.php?texid=$texid>К редактированию фотографий</a><br><br><p align=center><a href=autor.php>Вернуться в личный раздел</a></p><br><br>";
$txt="На сайте $siteadress - изменены фотографии к резюме #$texid";
if ($mailchange == 'TRUE')
{@mail($adminemail,"Изменение фотографий",$txt,"From: $adminemail\nReturn-Path:$adminemail\nMime-Version: 1.0\nContent-Type: text/plain; charset=windows-1251\nContent-Transfer-Encoding:8bit\n");}
}
echo ("
