...
if ($pr != 'print') {
echo ("
<table border=0 width=100%  cellspacing=0 cellpadding=0><tr><td><table border=0 cellspacing=1 cellpadding=2 width=100% class=tbl1><tr bgcolor=$maincolor><td>Отобранные вакансии&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>
");
if ($view != 'full') {echo "<a href=orderv.php?view=full>Подробный&nbsp;просмотр</a>";}
if ($view == 'full') {echo "<a href=orderv.php>Краткий&nbsp;вид</a>";}
echo ("
&nbsp;/&nbsp;<a href=orderv.php?view=$view&pr=print target=_blank>Печать</a></b></td></tr></table></td></tr></table><br>
");
}
...
echo ("
<tr bgcolor=$maincolor><td align=left colspan=2><b>Контактная информация</b></td></tr>
");
...
if ($email != '' and $hidemail == 'checked') {echo "<tr bgcolor=$maincolor><td valign=top>Email:</td><td><a href=\"send.php?sendid=$aid\">Написать письмо</a></td></tr>";}
...
if ($email != '' and $hidemail == 'checked') {$body .= "<b>Email</b>: скрыт пользователем (зайдите на сайт, чтобы отправить письмо)<br>";}
$body .= "</td></tr>";
