...
if ($pr != 'print') {
echo ("
<a href=zhaloba.php?r=res&link=$link>Пожаловаться на резюме</a><br>
");
}
if ($pr != 'print') {echo "<a href=linkres.php?link=$link&pr=print>Версия для печати</a><br>";}
if ($pr == 'print') {echo "<a href=linkres.php?link=$link>Обычная версия</a><br>";}
